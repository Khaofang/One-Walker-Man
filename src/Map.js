...
Map[2] = cc.Node.extend({
    ...
    createEnemy: function() {
        ...
        this.enemy[0].speedX = 1.25;
        this.enemy[1] = new Enemy[0]( 3 );
        this.addChild( this.enemy[1] );
        this.enemy[1].setPosition( new cc.Point( 425, 225 ) );
        this.enemy[1].speedX = -1.25;
    }
});
...
Map[4] = cc.Node.extend({
    ...
    createEnemy: function() {
        ...
        this.enemy[0].setPosition( new cc.Point( 425, 125 ) );
        this.enemy[0].speedX = 1.25;
        this.enemy[1].setPosition( new cc.Point( 425, 225 ) );
        this.enemy[1].speedX = -1.25;
        this.enemy[2].setPosition( new cc.Point( 425, 325 ) );
        this.enemy[2].speedX = 2.5;
        this.enemy[3].setPosition( new cc.Point( 425, 375 ) );
        this.enemy[3].speedX = -2.5;
    }
});
